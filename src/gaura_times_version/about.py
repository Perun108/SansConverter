    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(
            _translate(
                ...
                "<br/>"
                "<br/>"
                "SansConverter is an offline tool to easily convert romanized Sanskrit text from one system of transliteration to another."  # noqa
                "<br/>"
                "<br/>"
                "It can also be used to type in Sanskrit text with diacritics (using HK or Velthuis systems)."
                "<br/>"
                "<br/>"
                "Copyright © 2020 Kostiantyn Perun."
                "<br/>"
                "Version 1.7"
                "<br/>"
                ...
                "<br/>"
                "<br/>"
                'Send your feedback or suggestions to <a href= "mailto: kosperun@gmail.com">kosperun@gmail.com</a>',  # noqa
            )
        )
